...
function your_scripts() {
	...
	/*IFX 2021 Styles*/
	wp_enqueue_style( 'ifx-2021-styles', get_stylesheet_directory_uri() . '/css/ifx-2021.css', array(), '1.0.17' );
	/*Bootstrap JS*/
	...
	/*GlideJS*/
	wp_enqueue_script('glidejs', 'https://cdnjs.cloudflare.com/ajax/libs/Glide.js/3.4.1/glide.min.js', array(), null, true);
	/* IFX 2021 JS */
